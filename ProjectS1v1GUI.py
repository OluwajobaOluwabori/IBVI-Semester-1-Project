...
"}")
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.uipanel2)
        ...
        self.uipanel1 = QtWidgets.QGroupBox(self.groupBox)
        self.uipanel1.setGeometry(QtCore.QRect(10, 10, 141, 491))
        ...
        self.rbWire = QtWidgets.QRadioButton(self.uipaneldisplay)
        self.rbWire.setObjectName("rbWire")
        self.horizontalLayout_6.addWidget(self.rbWire)
        self.horizontalLayout_14.addLayout(self.horizontalLayout_6)
        self.verticalLayout_8.addWidget(self.uipaneldisplay)
        ...
        self.verticalLayout_8.addWidget(self.uipanelbackground)
